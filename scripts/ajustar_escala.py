...
from buildkite.functions_pyautogui.funcoes_teclado_mouse import click_center_screen, select_all, write_text, press_enter
    ...
    if do_scale == "sim":
        ...
        while do_again != "não":
            ...
            if set_scale_number.strip() == "":
                ...
                select_all()
                write_text(str(set_scale_number))
                press_enter(1)
                clear_clipboard()
                WAIT(1.5)
                click_center_screen()
