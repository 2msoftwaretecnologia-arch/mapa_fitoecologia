...
def texto_unidades_federacao():
    texto =  """
        import arcpy

        # Configurações
        nome_original = "BR_UF_2022"  # Nome da camada no mapa (ou caminho completo se necessário)
        novo_nome = "Unidades da Federação - IBGE (2022)"
        caminho_lyr = r"C:\\Users\\USUARIO\\Desktop\\automacoes\\envimap\\mapa_fitofisionomia\\cores_style\\Limites da Federação - IBGE (2022).lyr"
