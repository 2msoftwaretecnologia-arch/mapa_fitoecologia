...
from functions.manipular_arcgis.labels_federacao import *
from functions.manipular_arcgis.ajustar_regioes_fito import *
from functions.manipular_arcgis.ajustar_limites_municipal import *
...
from functions.tkinter.lembrete_checkbox import *
...
if Fechar == "Sim":
    ...
    fazer_grid()
    ajustar_escala()
    fazer_fitofisionomia()
    fazer_ajuste_limites_municipais()
