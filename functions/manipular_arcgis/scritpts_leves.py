...
from configs.configs_aii import *
from configs.configs_apr import *
from configs.estados_config import *
from configs.limites_municipais_config import *
...
def colar_scripts():
    ...
    texto_federacao = texto_unidades_federacao()
    texto_apr = texto_config_Apr(Text_infos.nome_propriedade)
    texto_aii = texto_config_Aii()
    texto_estados = texto_config_estados("Estado")
    texto_limites_municipais = text_limites_municipais_config()
    texto_info_propriedade = texto_substituir_nomes(Text_infos.proprietario,Text_infos.matricula,Text_infos.cidade_uf)
    
    textos_para_colar = [texto_federacao, texto_apr, texto_aii, texto_estados,texto_info_propriedade,texto_limites_municipais]
    esperar(1)
    abrir_console()
