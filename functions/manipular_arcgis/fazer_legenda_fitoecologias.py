...
escrever_texto(tamanhos_regioes_fito_ecologias["Savana Arborizada/Arbórea"]["2 vezes"]["borda"])
esperar(0.3)
enter(tempo=0.5)
selecionar_tudo_Word()
esperar(0.5)
for i in range(2):
    escrever_texto(tamanhos_regioes_fito_ecologias["Savana Arborizada/Arbórea"]["2 vezes"]["descricao"],velocidade=0.002)
    enter(2)
esperar(0.2)
selecionar_tudo_Word()
copiar()
