"""
Módulo de interfaces gráficas simples com Tkinter.

Contém utilitários para:
    - Escolher arquivos `.shp` (Shapefile) via janela do sistema operacional.
    - Exibir uma janela com checkbox para confirmação manual antes de continuar um processo.
