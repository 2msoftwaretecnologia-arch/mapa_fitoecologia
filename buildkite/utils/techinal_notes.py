...
def get_techinal_note_text():
    ...
    configs = {
        ...
        'Geologia': {
            ...
            'interface': lambda **kw: simple_choices(text_content="Geologia Predominante", **kw),
        ...
        'Pedologia': {
            ...
            'interface': lambda **kw: simple_choices(text_content="Pedologia Predominante", **kw),
            'items_attr': 'itens_atuais',
            'template': (
        ...
        'Regioes_climaticas': {
            ...
            'interface': lambda **kw: simple_choices(text_content="Região Climática Predominante", **kw),
            'items_attr': 'itens_atuais',
            'template': (
        ...
        'Declividade': {
            ...
            'interface': lambda **kw: simple_choices(text_content="Declividade Predominante", **kw),
            'items_attr': 'itens_atuais',
            'template': (
        ...
        'Erodibilidade': {
            ...
            'interface': lambda **kw: simple_choices(text_content="Erodibilidade Predominante", **kw),
            'items_attr': 'itens_atuais',
            'template': (
